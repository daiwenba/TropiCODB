...
<div id="group" class="in_group m" style="height: 620px">
    ...
    <form tf-list-form action="gene_family_result.php" class="form-search" method="post" style="margin-top:20px;">
        <p style="text-indent:2em;font-size: 20px;margin-bottom: 10px;float:left">List of species of tropical crops</p><input  type="checkbox" name="allChecked" id="allChecked" onchange="DoCheck()" style="margin-left: 20px"/><span style="font-size:14px;">Choose all/ Cancel</span>
